...
<section class="page-section" id="contact">
    <div class="container">
        ...
        <!-- to get an API token!-->
        <form enctype="multipart/form-data" id="contactForm" method="post" action="{{route('site2.postcontact')}}">
            @csrf
            <div class="row align-items-stretch mb-5">
                <div class="col-md-6">
                    ...
                    <div class="form-group mb-md-0 mt-3">
                        <input class="form-control" name="image" id="iamge" type="file" />
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="form-group form-group-textarea mb-md-0">
                        <!-- Message input-->
                        <textarea class="form-control" name="msg" id="message" placeholder="Your Message *"
